...
public : 
	...
	//verdiðim yýla yine verdiðim günü ekliyor 
	...
	bool IsValid()
	{
	 ...
	 static short NumberOfHoursInAYear(short Year)
		...
		//verilen bilgilere göre haftanýn kaçýýncý gününde olduðunuzuý söyler
		 ...
		 short DayOfWeekOrder()
		{
		 ...
		 //aþaðdaki  fonksiyon için static olmayan tür tanýmlamamýza gerek yok
		 // çünkü bu kendi baþýna ayrý bir fonksiyon belli bir  tarih veririm yaþýmý hesaplar
